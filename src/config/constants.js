...
export const WHATSAPP_MESSAGE_DEFAULT = "Hola, quiero acceder a la clase gratis para aprender a crear o hacer crecer mi negocio paso a paso.";

export const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE_DEFAULT)}`;

export const CTA_LINKS = {
  checkout: WHATSAPP_URL, // Cambiado para que todo apunte a la clase gratis inicialmente
